  ...
  return (
    <div className={style.page}>
      ...
      <div className={style.code}>
        <span style={{ color: '#DA6EB5' }}>const</span> <span style={{ color: '#82A3F1' }}>bio</span><span style={{ color: '#89DDF1' }}>: Developer</span><span style={{ color: '#DA6EB5' }}> = </span><span style={{ color: '#FFB913' }}>&#123;</span>
